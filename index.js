...
const unsupportedDevicesUrl = "http://127.0.0.1:5500/unsupportedDevice/unsup.html"
const mainUrl = "http://127.0.0.1:5500/main/main.html"
//---------------------------------------------------------------------------
...
window.onload = () => {
    if(isMobileDevice()){
        window.location.replace(unsupportedDevicesUrl)
